...
namespace GPS_Simulator
{
    ...
    class LocationService
    {
        ...
        private LocationService(MainWindow wnd) { wnd_instance = wnd; }
        public static LocationService GetInstance(MainWindow wnd) => _instance ?? (_instance = new LocationService(wnd));
